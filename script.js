...
const weapons = [
  { name: 'stick', power: 5 },
  { name: 'Hoe', power: 30 },
  { name: 'Sickle', power: 50 },
  { name: 'Pesticides', power: 100 }
];
const enemies = [
  {
    name: "Flea Beetles",
...
const locations = [
  {
    name: "town square",
    "button text": ["Go to store", "Go to field", "Fight pests"],
    "button functions": [goStore, goToField, fightDragon],
  ...
  {
    name: "field",
    "button text": ["Fight Flea Beetles", "Fight Spider Mites", "Go to town square"],
    "button functions": [fightFleaBeetles, fightSpiderMites, goTown],
    text: "You enter the field. You see some pests."
  },
  {
    name: "fight",
    "button text": ["Attack", "Dodge", "Run"],
    "button functions": [attack, dodge, goTown],
    text: "You are fighting the Pest."
  },
  {
    name: "kill Pest",
    "button text": ["Go to town square", "Go to town square", "Go to town square"],
    "button functions": [goTown, goTown, goTown],
    text: 'The Pest dies. You gain experience points and find gold.'
  },
  {
    name: "lose",
  ...
  { 
    ...
    "button text": ["REPLAY?", "REPLAY?", "REPLAY?"], 
    "button functions": [restart, restart, restart], 
    text: "You defeat the Pest! YOU WIN THE GAME! &#x1F389;" 
  },
  {
    name: "easter egg",
...
function fightFleaBeetles() {
  fighting = 0;
  goFight();
}

function fightSpiderMites() {
  fighting = 1;
  goFight();
}
